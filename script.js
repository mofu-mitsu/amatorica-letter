...
function setupMiniGame(type) {
    ...
    if (type === "input") {
        ...
        submitBtn.onclick = () => {
            ...
            } else if (/運命|永遠|尽く|守|一生|支え|幸せ/.test(val)) {
                // 【拡張】アガペーワード（永遠、尽くす、守る、支える、幸せなら）をまとめて検知！
                showToast("一途な宿命の愛 (アガペー+2, エロス+1)"); added = {"アガペー": 2, "エロス": 1};
                reply = "🥺「運命……永遠に尽くす……？ ふふ、そんなロマンチックで非科学的な概念を信じるのね。でも、私をそこまで特別視してくれるその献身（アガペー）、心地よくないわけじゃないわよ♡」";
